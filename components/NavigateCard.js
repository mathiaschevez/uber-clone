...
const NavigateCard = () => {
  ...
  return (
    <SafeAreaView style={tw `bg-gray-200 flex-1`}>
      <Text style={tw `text-center py-5 text-xl`}>Good Morning, Mathias</Text>
      ...
      <View style={tw `flex-row bg-gray-200 justify-evenly pb-6 pt-2 mt-auto border-t border-white`}>
